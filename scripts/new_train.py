...
from gia.datasets import get_task_name_list, needs_prompt
...
def main():
    ...
    seq_len = 1024  # to get from the model config
    ...
    # TODO: next, concatenate all the datasets, and create the test dataset
