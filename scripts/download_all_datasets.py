...
if tasks == ["all"]:
    tasks = get_dataset_config_names("jat-project/jat-dataset-tokenized-gemma")  # get all task names from jat dataset
...
for task in tasks:
    ...
    cache_path = f"{HF_DATASETS_CACHE}/jat-project/jat-dataset-tokenized-gemma/{task}"
