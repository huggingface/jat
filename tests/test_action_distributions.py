...
def test_simple_distribution(gym_space, batch_size):
...
@pytest.mark.parametrize("batch_size", [128])
def test_tuple_distribution(num_spaces, gym_space, batch_size):
...
def test_tuple_sanity_check(num_spaces, num_actions):
