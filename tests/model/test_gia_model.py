...
def test_gia_model(test_mode, input_mode):
    ...
    input_ids = torch.randint(0, 256, (2, 32)) if input_mode in ["input_ids", "both"] else None
    patches = (
...
def test_gia_model_attention_mask():
    ...
    input_ids_1 = torch.randint(0, 256, (2, 32))
    ...
    torch.testing.assert_allclose(output_1.logits, output_2.logits)
