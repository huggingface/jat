...
class GatoModel(PreTrainedModel):
    r"""
    GatoModel is a wrapper around a transformer model that takes in both text and image patches as input.
    ...
    config_class = GatoConfig
    base_model_prefix = "gia"

    def __init__(self, config: GatoConfig) -> None:
...
AutoModel.register(GatoConfig, GatoModel)
