...
from gato.datasets import get_task_name_list
...
class ModelArguments:
    ...
    Parameters:
        model_name_or_path (`str`, *optional*):
            ...
            `"gia-project/gato-80m"`, `"gia-project/gato-387m"`, `"gia-project/gato-1.27b"` (default).
    ...
    model_name_or_path: str = field(
        default="gia-project/gato-1.27b",
        metadata={
            "help": (
                "Path to pretrained model or model identifier from huggingface.co/models: one of "
                "`'gia-project/gato-80m'`, `'gia-project/gato-387m'`, `'gia-project/gato-1.27b'` (default)."
...
class WandBArguments:
    ...
    wandb_entity: str = field(
        default="gato",
        metadata={"help": "The entity to store runs under. Defaults to `'gato'`."},
    )
