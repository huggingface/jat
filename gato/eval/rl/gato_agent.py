...
class GatoAgent:
    ...
    Args:
        ...
        task_name (`str`):
            The environment id. Check the available task names with `GatoAgent.get_available_task_names()`.
        collator (`GatoDataCollator`):
            The GatoDataCollator to use for collating processed observations.
    ...
    def __init__(
        ...
        self.collator = GatoDataCollator()
