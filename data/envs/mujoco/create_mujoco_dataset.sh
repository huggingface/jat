...
for ENV in "${ENVS[@]}"; do
    ...
    echo $ENV
    python create_mujoco_dataset.py --env=mujoco_${ENV} --experiment=mujoco_${ENV}_1111 --train_dir=train_dir --push_to_hub --max_num_frames=1000000000 --no_render --max_num_episodes=10000
done